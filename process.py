...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='isnet-general-use', type=str, help="rembg model, see https://github.com/danielgatis/rembg#models")
    ...
    for file in files:
        ...
        #mask2 = carved_image[:, :, :3].sum(-1) > 0.1
        #print(mask2.shape)
        #carved_image = carved_image[mask2]
        #print(carved_image.shape)
        #assert False
        #print(mask2.shape, mask2.sum(),'.......')
        #mask = mask * mask2
