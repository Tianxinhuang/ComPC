    ...
    def train_step(self):
        ...
        for _ in range(self.train_steps):
            ...
            for _ in range(self.opt.batch_size):
                ...
                #cur_cam = MiniCam(pose, self.intri[0], self.intri[1], self.intri[2], self.intri[2], 0.01, 100)
            ...
            cd_loss = self.renderer.gaussians.chamfer(self.renderer.gaussians.get_xyz.unsqueeze(0), points.unsqueeze(0))
