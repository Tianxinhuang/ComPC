...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, gaussians_count, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
    ...
    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_alpha, grad_count):
